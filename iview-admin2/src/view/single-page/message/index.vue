    ...
    <div>
      <div class="message-page-con message-category-con">
        <Menu width="auto" active-name="unread" @on-select="handleSelect">
          <!-- <MenuItem name="send">
            <span class="category-title">发送消息</span>
          </MenuItem> -->
          ...
          <MenuItem name="trash">
            ...
            <p class='little-font'>提示：仅存10条消息</p>
          </MenuItem>
        </Menu>
      </div>
...
// functino dealDateFormat(oldDateStr) {
//   oldstring = oldDateStr.split('T'),
//   newstring = oldstring[0] + ' ' + oldstring[1].split('+')[0],
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      messageList () {
        console.log(this[listDic[this.currentMessageType]])
